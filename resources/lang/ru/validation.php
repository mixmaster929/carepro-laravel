...
return [
    'captcha' => 'Пожалуйста, введите правильный код на картинке CAPTCHA',
    ...
    'ends_with' => 'Атрибут: должен заканчиваться одним из следующих значений:attribute',
    ...
    'max' => [
        ...
        'array' => 'Атрибут: может содержать не более: макс.',
    ],
    ...
    'required_with' => 'Поле: атрибут обязательное, если присутствует: значения.',
    ...
    'starts_with' => 'Атрибут: должен начинаться с одного из следующих значений:attribute values',
