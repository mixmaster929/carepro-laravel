...
@section('content')
    <form action="{{ isset($vacancy)? route('candidate.save-profile-vacancy', ['vacancy' => $vacancy]) : route('candidate.save-profile') }}" method="post" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    <div class="card-header" id="heading{{ $group->id }}">
                        ...
                        <div class="card-body row">
                            ...
                            @if(isset($vacancy) && $field->required)
                                <?php
    ...
    <div class="form-group col-md-6">
        <input class="btn btn-primary" type="submit" value="{{ isset($vacancy)? __('site.save-changes-vacancy') : __('site.save-changes') }}">
    </div>
