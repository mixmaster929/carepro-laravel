...
@section('title')
    ...
    {!! clean( trans('installer_messages.environment.wizard.title') ) !!}
@endsection
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('environment') ? ' has-error ' : '' }}">
                    ...
                    <div id="environment_text_input int_hide" >
...
@section('scripts')
    <script src="{{ asset('js/installer.js') }}" type="text/javascript"></script>
@endsection
