        ...
        <div class="buttons buttons--right">
            <button class="button button--light" type="submit">
            	<i class="fa fa-floppy-o fa-fw" aria-hidden="true"></i>
             	{!! clean( trans('installer_messages.environment.classic.save') ) !!}
            </button>
        </div>
    </form>
    ...
    @if( ! isset($environment['errors']))
        <div class="buttons-container">
            <a class="button float-left" href="{{ route('LaravelInstaller::environmentWizard') }}">
                ...
                {!! clean( trans('installer_messages.environment.classic.back') ) !!}
            </a>
            <a class="button float-right" href="{{ route('LaravelInstaller::database') }}">
                <i class="fa fa-check fa-fw" aria-hidden="true"></i>
                {!! clean( trans('installer_messages.environment.classic.install') ) !!}
