<div class="form-group {{ $errors->has('content') ? 'has-error' : ''}}">
    ...
    <textarea class="form-control" rows="5" name="content" type="textarea" id="content" >{{ old('content',isset($employmentcomment->content) ? $employmentcomment->content : '') }}</textarea>
...
@if($formMode=='edit' && $employmentcomment->employmentCommentAttachments()->count() > 0)
    <div  class="int_tpmb">
        <p  >
            ...
            <div class="row" >
                @foreach($employmentcomment->employmentCommentAttachments as $attachment)
                      <div    class="col-md-4 int_mth"  >
                          ...
                          <a  onclick="return confirm(&quot;@lang('site.confirm-delete')&quot;)"  class="int_mt10 btn btn-danger btn-block btn-sm" href="{{ route('admin.employment-comments.delete-attachment',['employmentCommentAttachment'=>$attachment->id]) }}"><i class="fa fa-trash"></i> @lang('site.delete')</a>
                        </div>
