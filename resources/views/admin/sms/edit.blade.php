...
@section('pageTitle',__('site.edit').' '.__('site.text-message').' #'.$sm->id)
@section('page-title',__('site.edit').' '.__('site.text-message').' #'.$sm->id)
...
@endsection
@include('admin.sms.form-include', ['formMode' => 'edit'])