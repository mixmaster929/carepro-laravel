...
@section('pageTitle',__('site.blog'))
@section('page-title',__('site.create-new').' '.__('site.blog-post'))
            ...
            <div class="col-md-12">
                <div  >
                    <div >
                        ...
                        <form method="POST" action="{{ url('/admin/blog-posts') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}

                            @include ('admin.blog-posts.form', ['formMode' => 'create'])
