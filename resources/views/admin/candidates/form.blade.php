            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 {{ $errors->has('clientnumber') ? 'has-error' : ''}}">
                        ...
                        <input @if($formMode!='edit') readonly @endif class="form-control" name="clientnumber" type="text" id="clientnumber" value="{{ old('clientnumber',isset($candidate->clientnumber) ? $candidate->clientnumber : '') }}" >
