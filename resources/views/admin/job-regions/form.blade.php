<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
    ...
    <input required class="form-control" name="name" type="text" id="name" value="{{ old('name',isset($jobregions->name) ? $jobregions->name : '') }}" >
...
<div class="form-group {{ $errors->has('sort_order') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="sort_order" type="text" id="sort_order" value="{{ old('sort_order',isset($jobregions->sort_order) ? $jobregions->sort_order : '') }}" >
