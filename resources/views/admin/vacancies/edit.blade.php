            ...
            <div class="col-md-12">
                <div  >
                    <div  >
                        ...
                        <form method="POST" action="{{ url('/admin/vacancies/' . $vacancy->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}

                            @include ('admin.vacancies.form', ['formMode' => 'edit'])
...
@include('admin.vacancies.form-include')