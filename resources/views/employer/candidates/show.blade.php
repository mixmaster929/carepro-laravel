...
@section('content')
    <div>
        <div>
            ...
            <!-- <a href="{{ url('/employer/candidates/' . $candidate->id . '/edit') }}" title="@lang('site.edit')"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> @lang('site.edit')</button></a>
