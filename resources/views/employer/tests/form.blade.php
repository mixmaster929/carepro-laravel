<div class="form-group {{ $errors->has('user_id') ? 'has-error' : ''}}">
    <label for="user_id" class="control-label required">@lang('site.creator')</label>
    <input class="form-control" name="user_id" type="hidden" id="user_id" value="{{ $user->id }}" >
    <input readonly class="form-control" name="user_name" type="text" id="user_name" value="{{ $user->name }}" >
